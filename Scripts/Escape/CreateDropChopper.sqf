...
private ["_spawnPos", "_side", "_minSkill", "_maxSkill", "_onGroupDropped", "_dropGroup", "_debug", "_chopper", "_group", "_pilot", "_gunner1", "_gunner2", "_currentInstanceNo", "_crewType", "_chopperType", "_dropPosition"];
...
[_chopper, _dropGroup, _dropPosition, _onGroupDropped, _debug] execVM "Scripts\Escape\DropChopper.sqf";
