...

{
    if (!isNil "_x") then {
        ...
        _x createDiaryRecord ["Diary", ["Background", "The earthquake shaking the Horizon Islands has brought more than a natural disaster. In the chaos of humanitarian efforts being carried out across the island, CSAT has found a unique opportunity to further destabilise the region by strengthening the Syndicat. The Syndicat has since then increased its activities and, in absence of the Gendarmarie, taken over control of cities and villages of Tanoa at a relatively low cost.<br /><br />In the resulting political vacuum the Gendarmarie is nowhere to be seen, but it is assumed to be silently regrouping and preparing the arrival of NATO piecekeeping forces."]];
